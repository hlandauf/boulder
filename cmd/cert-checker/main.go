...
func newChecker(saDbMap *gorp.DbMap, paDbMap *gorp.DbMap, clk clock.Clock, challengeTypes map[string]bool) certChecker {
	pa, err := policy.NewPolicyAuthorityImpl(paDbMap, challengeTypes)
...
func main() {
	...
	app.Action = func(c cmd.Config, stats statsd.Statter, auditlogger *blog.AuditLogger) {
		...
		checker := newChecker(saDbMap, paDbMap, clock.Default(), c.PA.Challenges)
